...
laptop.register_view("servers.minetest/persistentkingdoms", {
	...
	formspec_func = function(app, mtos)
		local formspec = laptop.browser_api.header_formspec_func(app, mtos) ..
			...
			mtos.theme:get_button('.6,3.55;5,.5', 'url_bright', 'page_link', 'servers.minetest/persistentkingdoms/map')..
...
laptop.register_view("servers.minetest/persistentkingdoms/map", {
